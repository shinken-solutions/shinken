...
The following variables determine the timeframes in which a previous host or service check result may be used as a cached host or service check result:
  ...
  * The :ref:`cached_host_check_horizon <configuringshinken/configmain-advanced#cached_host_check_horizon>` variable controls cached host checks.
  * The :ref:`cached_service_check_horizon <configuringshinken/configmain-advanced#cached_service_check_horizon>` variable controls cached service checks.
...
The monitoring installation which produced the graphs above had:
  ...
  * A :ref:`cached_host_check_horizon <configuringshinken/configmain-advanced#cached_host_check_horizon>` of 15 seconds
