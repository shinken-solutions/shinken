.. _integrationwithothersoftware/webui:
...
You can link the WebUI so it will present graphs from other tools, like :ref:`PNP4Nagios <integrationwithothersoftware/pnp>` or Graphite. All you need is to declare such modules (there are already samples in the default configuration) and add them in the WebUI **modules** definition.
