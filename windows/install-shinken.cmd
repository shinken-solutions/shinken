...
copy /Y ..\libexec\check_wmi_plus.pltpl ..\libexec\check_wmi_plus.pl
copy /Y ..\libexec\check_wmi_plus.conftpl ..\libexec\check_wmi_plus.conf
...
cscript replace_perl_installdir.vbs .\libexec\check_wmi_plus.pl @@installdir@@ "%cd%"
cscript replace_perl_installdir.vbs .\libexec\check_wmi_plus.conf @@installdir@@ "%cd%"
