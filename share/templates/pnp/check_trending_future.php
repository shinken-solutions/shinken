...
# Trend
#
$opt[1] = "--vertical-label \"$UNIT[1]\" --title \"Planned value - $hostname / $servicedesc\" ";
#
#
#

$def[1] =  "DEF:var2=$RRDFILE[1]:$DS[1]:AVERAGE " ;
$def[1] .= "AREA:var2#07FA0A:\"$NAME[1] \" " ;
$def[1] .= "LINE1:var2#000000 " ;
$def[1] .= "GPRINT:var2:LAST:\"%3.4lf$UNIT[1] last\" " ;
$def[1] .= "GPRINT:var2:AVERAGE:\"%3.4lf$UNIT[1] avg\" " ;
$def[1] .= "GPRINT:var2:MAX:\"%3.4lf$UNIT[1] max\\n\" ";
...
# Scenario NoSteps
#
$opt[2] = "--vertical-label \"$UNIT[2]\" --title \"Weekly evolution - $hostname / $servicedesc\" ";
#
#
#
$def[2] =  "DEF:var1=$RRDFILE[2]:$DS[2]:AVERAGE " ;
$def[2] .= "AREA:var1#FF00FF:\"$NAME[2] \" " ;
