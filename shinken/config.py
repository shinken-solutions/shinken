...
class Config(Item):
    ...
    properties={'prefix' : {'required':False, 'default' : '/usr/local/shinken/'},
                ...
                'host_perfdata_file' : {'required':False, 'default':'' , 'class_inherit' : [(Host, 'perfdata_file')], 'usage' : 'unmanaged'},
                'service_perfdata_file' : {'required':False, 'default':'' , 'class_inherit' : [(Service, 'perfdata_file')], 'usage' : 'unmanaged'},
