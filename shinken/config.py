...
#        self.arbiterlinks.fill_default()
    ...
    def hack_old_nagios_parameters(self):
        ...
        if self.state_retention_file != '':
            #Ok, we've got a old retention file
            got_retention_file_module = self.got_broker_module_type_defined('nagios_retention_file')
...
#        self.modules.create_reversed_list()
    ...
    def is_correct(self):
        ...
        #Escalations
        Log().log('Checking escalations...')
        r &= self.escalations.is_correct()
        Log().log('\tChecked %d escalations' % len(self.escalations))
