...
class Config(Item):
    ...
    properties={'prefix' : {'required':False, 'default' : '/usr/local/shinken/'},
                ...
                'log_rotation_method' : {'required':False, 'default':'d', 'pythonize': to_char, 'usage' : 'unused', 'usage_text' : 'sorry, log rotation is not already implemented'},
                'log_archive_path' : {'required':False, 'default':'/tmp/', 'usage' : 'unused', 'usage_text' : 'sorry, log rotation is not already implemented'},
                ...
                'external_command_buffer_slots' : {'required':False, 'default':'512', 'pythonize': to_int, 'usage' : 'unused', 'usage_text' : 'sorry, log rotation is not already implemented'},
                ...
                'retain_state_information' : {'required':False, 'default':'1', 'pythonize': to_bool, 'usage' : 'unused', 'usage_text' : 'sorry, log rotation is not already implemented'},
                'state_retention_file' : {'required':False, 'default':'/tmp/retention.dat', 'usage' : 'unused', 'usage_text' : 'sorry, log rotation is not already implemented'},
                'retention_update_interval' : {'required':False, 'default':'60', 'pythonize': to_int},
                'use_retained_program_state' : {'required':False, 'default':'1', 'pythonize': to_bool, 'usage' : 'unused', 'usage_text' : 'sorry, log rotation is not already implemented'},
                'use_retained_scheduling_info' : {'required':False, 'default':'1', 'pythonize': to_bool, 'usage' : 'unused', 'usage_text' : 'sorry, log rotation is not already implemented'},
                'retained_host_attribute_mask' : {'required':False, 'default':'0', 'class_inherit' : [(Host, 'retained_attribute_mask')], 'usage' : 'unused', 'usage_text' : 'sorry, log rotation is not already implemented'},
                'retained_service_attribute_mask' : {'required':False, 'default':'0', 'class_inherit' : [(Service, 'retained_attribute_mask')], 'usage' : 'unused', 'usage_text' : 'sorry, log rotation is not already implemented'},
                'retained_process_host_attribute_mask' : {'required':False, 'default':'0', 'class_inherit' : [(Host, 'retained_process_attribute_mask')], 'usage' : 'unused', 'usage_text' : 'sorry, log rotation is not already implemented'},
                'retained_process_service_attribute_mask' : {'required':False, 'default':'0', 'class_inherit' : [(Host, 'retained_process_attribute_mask')], 'usage' : 'unused', 'usage_text' : 'sorry, log rotation is not already implemented'},
                'retained_contact_host_attribute_mask' : {'required':False, 'default':'0', 'class_inherit' : [(Host, 'retained_contact_attribute_mask')], 'usage' : 'unused', 'usage_text' : 'sorry, log rotation is not already implemented'},
                'retained_contact_service_attribute_mask' : {'required':False, 'default':'0', 'class_inherit' : [(Service, 'retained_contact_attribute_mask')], 'usage' : 'unused', 'usage_text' : 'sorry, log rotation is not already implemented'},
                'use_syslog' : {'required':False, 'default':'0', 'pythonize': to_bool, 'usage' : 'unused', 'usage_text' : 'sorry, log rotation is not already implemented'},
                ...
                'max_concurrent_checks' : {'required':False, 'default':'200', 'pythonize': to_int, 'usage' : 'unused', 'usage_text' : 'sorry, log rotation is not already implemented'},
                ...
                'auto_reschedule_checks' : {'required':False, 'default':'1', 'pythonize': to_bool, 'class_inherit' : [(Host, None), (Service, None)], 'usage' : 'unused', 'usage_text' : 'sorry, log rotation is not already implemented'},
                'auto_rescheduling_interval' : {'required':False, 'default':'30', 'pythonize': to_int, 'class_inherit' : [(Host, None), (Service, None)], 'usage' : 'unused', 'usage_text' : 'sorry, log rotation is not already implemented'},
                'auto_rescheduling_window' : {'required':False, 'default':'180', 'pythonize': to_int, 'class_inherit' : [(Host, None), (Service, None)], 'usage' : 'unused', 'usage_text' : 'sorry, log rotation is not already implemented'},
                'use_aggressive_host_checking' : {'required':False, 'default':'1', 'pythonize': to_bool, 'class_inherit' : [(Host, None)], 'usage' : 'unused', 'usage_text' : 'sorry, log rotation is not already implemented'},
                'translate_passive_host_checks' : {'required':False, 'default':'1', 'pythonize': to_bool, 'class_inherit' : [(Host, 'translate_passive_checks')], 'usage' : 'unused', 'usage_text' : 'sorry, log rotation is not already implemented'},
                'passive_host_checks_are_soft' : {'required':False, 'default':'1', 'pythonize': to_bool, 'class_inherit' : [(Host, 'passive_checks_are_soft')], 'usage' : 'unused', 'usage_text' : 'sorry, log rotation is not already implemented'},
                'enable_predictive_host_dependency_checks' : {'required':False, 'default':'1', 'pythonize': to_bool, 'class_inherit' : [(Host, 'enable_predictive_dependency_checks')], 'usage' : 'unused', 'usage_text' : 'sorry, log rotation is not already implemented'},
                'enable_predictive_service_dependency_checks' : {'required':False, 'default':'1', 'class_inherit' : [(Service, 'enable_predictive_dependency_checks')], 'usage' : 'unused', 'usage_text' : 'sorry, log rotation is not already implemented'},
                ...
                'use_large_installation_tweaks' : {'required':False, 'default':'0', 'pythonize': to_bool, 'usage' : 'unused', 'usage_text' : 'Shinken is always tweaks.'},
                ...
                'enable_environment_macros' : {'required':False, 'default':'1', 'pythonize': to_bool, 'class_inherit' : [(Host, None), (Service, None)], 'usage' : 'unused', 'usage_text' : 'sorry, not already implemented'},
                ...
                'soft_state_dependencies' : {'required':False, 'default':'0', 'pythonize': to_bool, 'class_inherit' : [(Host, None), (Service, None)], 'usage' : 'unused', 'usage_text' : 'sorry, not already implemented'},
                ...
                'ocsp_timeout' : {'required':False, 'default':'5', 'pythonize': to_int, 'class_inherit' : [(Service, None)], 'usage' : 'unused', 'usage_text' : 'O*HP commands are only useful for old distributed architecture, so no use with Shinken'},
                'ochp_timeout' : {'required':False, 'default':'5', 'pythonize': to_int, 'class_inherit' : [(Host, None)], 'usage' : 'unused', 'usage_text' : 'O*HP commands are only useful for old distributed architecture, so no use with Shinken'},
                'perfdata_timeout' : {'required':False, 'default':'2', 'pythonize': to_int, 'class_inherit' : [(Host, None), (Service, None)], 'usage' : 'unused', 'usage_text' : 'Perfdata are manage by a broker module, not as a global parameter.'},
                'obsess_over_services' : {'required':False, 'default':'0', 'pythonize': to_bool, 'class_inherit' : [(Service, 'obsess_over')], 'usage' : 'unused', 'usage_text' : 'O*HP commands are only useful for old distributed architecture, so no use with Shinken'},
                'ocsp_command' : {'required':False, 'default':'', 'class_inherit' : [(Service, None)], 'usage' : 'unused', 'usage_text' : 'O*HP commands are only useful for old distributed architecture, so no use with Shinken'},
                'obsess_over_hosts' : {'required':False, 'default':'0', 'pythonize': to_bool, 'class_inherit' : [(Host, 'obsess_over')], 'usage' : 'unused', 'usage_text' : 'O*HP commands are only useful for old distributed architecture, so no use with Shinken'},
                'ochp_command' : {'required':False, 'default':'', 'class_inherit' : [(Host, None)], 'usage' : 'unused', 'usage_text' : 'O*HP commands are only useful for old distributed architecture, so no use with Shinken'},
                'process_performance_data' : {'required':False, 'default':'1', 'pythonize': to_bool , 'class_inherit' : [(Host, None), (Service, None)]},
                'host_perfdata_command' : {'required':False, 'default':'' , 'class_inherit' : [(Host, 'perfdata_command')], 'usage' : 'unused', 'usage_text' : 'Perfdata are manage by a broker module, not as a global parameter.'},
                'service_perfdata_command' : {'required':False, 'default':'', 'class_inherit' : [(Service, 'perfdata_command')], 'usage' : 'unused', 'usage_text' : 'Perfdata are managed by a broker module, not as a global parameter.'},
                'host_perfdata_file' : {'required':False, 'default':'/tmp/host.perf' , 'class_inherit' : [(Host, 'perfdata_file')], 'usage' : 'unused', 'usage_text' : 'Perfdata are managed by a broker module, not as a global parameter.'},
                'service_perfdata_file' : {'required':False, 'default':'/tmp/service.perf' , 'class_inherit' : [(Service, 'perfdata_file')], 'usage' : 'unused', 'usage_text' : 'Perfdata are managed by a broker module, not as a global parameter.'},
                'host_perfdata_file_template' : {'required':False, 'default':'/tmp/host.perf', 'class_inherit' : [(Host, 'perfdata_file_template')], 'usage' : 'unused', 'usage_text' : 'Perfdata are managed by a broker module, not as a global parameter.'},
                'service_perfdata_file_template' : {'required':False, 'default':'/tmp/host.perf', 'class_inherit' : [(Service, 'perfdata_file_template')], 'usage' : 'unused', 'usage_text' : 'Perfdata are managed by a broker module, not as a global parameter.'},
                'host_perfdata_file_mode' : {'required':False, 'default':'a', 'pythonize': to_char, 'class_inherit' : [(Host, 'perfdata_file_mode')], 'usage' : 'unused', 'usage_text' : 'Perfdata are managed by a broker module, not as a global parameter.'},
                'service_perfdata_file_mode' : {'required':False, 'default':'a', 'pythonize': to_char, 'class_inherit' : [(Service, 'perfdata_file_mode')], 'usage' : 'unused', 'usage_text' : 'Perfdata are managed by a broker module, not as a global parameter.'},
                'host_perfdata_file_processing_interval' : {'required':False, 'default':'15', 'pythonize': to_int, 'usage' : 'unused', 'usage_text' : 'Perfdata are managed by a broker module, not as a global parameter.'},
                'service_perfdata_file_processing_interval' : {'required':False, 'default':'15', 'pythonize': to_int, 'usage' : 'unused', 'usage_text' : 'Perfdata are managed by a broker module, not as a global parameter.'},
                'host_perfdata_file_processing_command' : {'required':False, 'default':'', 'class_inherit' : [(Host, 'perfdata_file_processing_command')], 'usage' : 'unused', 'usage_text' : 'Perfdata are managed by a broker module, not as a global parameter.'},
                'service_perfdata_file_processing_command' : {'required':False, 'default':'', 'class_inherit' : [(Service, 'perfdata_file_processing_command')], 'usage' : 'unused', 'usage_text' : 'Perfdata are managed by a broker module, not as a global parameter.'},
                ...
                'additional_freshness_latency' : {'required':False, 'default':'15', 'pythonize': to_int, 'class_inherit' : [(Host, None), (Service, None)], 'usage' : 'unused', 'usage_text' : 'sorry, not yet implemented.'},
                'enable_embedded_perl' : {'required':False, 'default':'1', 'pythonize': to_bool, 'usage' : 'unused', 'usage_text' : 'sorry, not yet implemented'},
                'use_embedded_perl_implicitly' : {'required':False, 'default':'0', 'pythonize': to_bool, 'usage' : 'unused', 'usage_text' : 'sorry, not yet implemented.'},
                'date_format' : {'required':False, 'default':'us', 'class_inherit' : [(Host, None), (Service, None), (Contact, None)], 'usage' : 'unused', 'usage_text' : 'sorry, not yet implemented.'},
                'use_timezone' : {'required':False, 'default':'FR/Paris', 'class_inherit' : [(Host, None), (Service, None), (Contact, None)], 'usage' : 'unused', 'usage_text' : 'sorry, not yet implemented.'},
                'illegal_object_name_chars' : {'required':False, 'default':'/tmp/', 'usage' : 'unused', 'usage_text' : 'sorry, not yet implemented.'},
                'illegal_macro_output_chars' : {'required':False, 'default':'', 'class_inherit' : [(Host, None), (Service, None), (Contact, None)], 'usage' : 'unused', 'usage_text' : 'sorry, not yet implemented.'},
                'use_regexp_matching' : {'required':False, 'default':'1', 'pythonize': to_bool, 'class_inherit' : [(Host, None), (Service, None), (Contact, None)], 'usage' : 'unused', 'usage_text' : 'sorry, not yet implemented.'},
                'use_true_regexp_matching' : {'required':False, 'default':'0', 'pythonize': to_bool, 'class_inherit' : [(Host, None), (Service, None), (Contact, None)], 'usage' : 'unused', 'usage_text' : 'sorry, not yet implemented.'},
            ...
            for prop in properties:
                ...
                if 'usage' in entry and entry['usage'] == 'unmanaged' and hasattr(self, prop):
                    if 'usage_text' in entry:
                        ...
                        usage_text = "this parameter is not managed from now. "
                    mailing_list_uri = "https://lists.sourceforge.net/lists/listinfo/shinken-devel"
                    text = 'Warning : the parameter %s is not managed from now. If you really need it, please aregister at the devel mailing list at %s and ask for it or propose us a patch :)' % (prop, mailing_list_uri)
                    Log().log(text)
