...
####
    ...
    def raise_alert_log_entry(self):
        send_result('SERVICE ALERT: %s;%s;%s;%s;%d;%s'
    ...
    def raise_initial_state(self):
        if self.__class__.log_initial_states:
            send_result('CURRENT SERVICE STATE: %s;%s;%s;%s;%d;%s'
                        % (self.host.get_name(), self.get_name(),
                           self.state, self.state_type,
                           self.attempt, self.output))
    ...
    def raise_notification_log_entry(self, n):
        ...
        if self.__class__.log_notifications:
            send_result("SERVICE NOTIFICATION: %s;%s;%s;%s;%s;%s"
                        % (contact.get_name(),
    ...
    def raise_event_handler_log_entry(self, command):
        if self.__class__.log_event_handlers:
            send_result("SERVICE EVENT HANDLER: %s;%s;%s;%s;%s;%s"
                        % (self.host.get_name(), self.get_name(),
                           self.state, self.state_type,
    ...
    def raise_flapping_start_log_entry(self, change_ratio, threshold):
        send_result("SERVICE FLAPPING ALERT: %s;%s;STARTED; "
    ...
    def raise_flapping_stop_log_entry(self, change_ratio, threshold):
        send_result("SERVICE FLAPPING ALERT: %s;%s;STOPPED; "
    ...
    def raise_enter_downtime_log_entry(self):
        send_result("SERVICE DOWNTIME ALERT: %s;%s;STARTED; "
    ...
    def raise_exit_downtime_log_entry(self):
        send_result("SERVICE DOWNTIME ALERT: %s;%s;STOPPED; Service "
    ...
    def raise_cancel_downtime_log_entry(self):
        send_result("SERVICE DOWNTIME ALERT: %s;%s;CANCELLED; "
