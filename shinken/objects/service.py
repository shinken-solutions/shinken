...
class Service(SchedulingItem):
    ...
    properties.update({
        ...
        'check_command':          StringProp(fill_brok=['full_status'],retention=True, modattr=512),
        'initial_state':          CharProp(default='o', fill_brok=['full_status']),
        'max_check_attempts':     IntegerProp(default='1',fill_brok=['full_status'],retention=True, modattr=4096),
        'check_interval':         IntegerProp(fill_brok=['full_status'],retention=True, modattr=1024),
        'retry_interval':         IntegerProp(fill_brok=['full_status'],retention=True, modattr=2048),
        'active_checks_enabled':  BoolProp(default='1', fill_brok=['full_status'], retention=True, modattr=2),
        'passive_checks_enabled': BoolProp(default='1', fill_brok=['full_status'], retention=True, modattr=4),
        'check_period':           StringProp(brok_transformation=to_name_if_possible, fill_brok=['full_status'],retention=True, modattr=16384),
        'obsess_over_service':    BoolProp(default='0', fill_brok=['full_status'], retention=True,modattr=128),
        'check_freshness':        BoolProp(default='0', fill_brok=['full_status'], retention=True,modattr=8192),
        'freshness_threshold':    IntegerProp(default='0', fill_brok=['full_status']),
        'event_handler':          StringProp(default='', fill_brok=['full_status'], retention=True,modattr=256),
        'event_handler_enabled':  BoolProp(default='0', fill_brok=['full_status'], retention=True, modattr=8),
        ...
        'flap_detection_enabled': BoolProp(default='1', fill_brok=['full_status'], retention=True, modattr=16),
        'flap_detection_options': ListProp(default='o,w,c,u', fill_brok=['full_status']),
        'process_perf_data':      BoolProp(default='1', fill_brok=['full_status'], retention=True, modattr=64),
        ...
        'notification_period':    StringProp(brok_transformation=to_name_if_possible, fill_brok=['full_status'], retention=True, modattr=65536),
        'notification_options':   ListProp(default='w,u,c,r,f,s', fill_brok=['full_status']),
        'notifications_enabled':  BoolProp(default='1', fill_brok=['full_status'], retention=True, modattr=1),
        ...
        'failure_prediction_enabled': BoolProp(default='0', fill_brok=['full_status'],retention=True, modattr=32),
