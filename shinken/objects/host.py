...
class Host(SchedulingItem):
    ...
    properties.update({
        ...
        'check_command':        StringProp(default='_internal_host_up', fill_brok=['full_status'],retention=True, modattr=512),
        ...
        'check_interval':       IntegerProp(default='0', fill_brok=['full_status'],retention=True, modattr=1024),
        'retry_interval':       IntegerProp(default='0', fill_brok=['full_status'],retention=True, modattr=2048),
        ...
        'obsess_over_host':     BoolProp(default='0', fill_brok=['full_status'], retention=True, modattr=128),
