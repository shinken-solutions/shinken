...
DICT_MODATTR = {
    ...
    "MODATTR_PERFORMANCE_DATA_ENABLED": ModAttr("MODATTR_PERFORMANCE_DATA_ENABLED", "process_perf_data", 64),
    "process_perf_data": ModAttr("MODATTR_PERFORMANCE_DATA_ENABLED", "process_perf_data", 64),
