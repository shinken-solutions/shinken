...
<div class='span2 pull-right'>
  <a class='btn btn-info' href="/objects/add/contact"><i class="icon-plus"></i> Add new contact</a>
</div>
...
<div class='offset1 span10'>
  ...
  <div class='object_{{elt_type}} span12'>
    <div class='host_name cut-long pull-left'><a href='/objects/hosts/{{h.get_name()}}'>{{h.get_name()}}</a>
