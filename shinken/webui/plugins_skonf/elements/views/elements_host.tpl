...
<div class="row-fluid">
	<form data-table='hosts' name='form-element'>
		...
		<ul class="nav nav-tabs">
			...
			<a class="btn btn-small btn-info pull-right {{editable}}" href="javascript:submit_form()"><i class="icon-ok"></i> Submit</a>
		</ul>
		...
		<div class="tab-content row-fluid">
			...
			<div class="tab-pane active" id="generic">
				<div class="span6">
					{{!helper.get_string_input(elt, 'host_name', 'Hostname', span='', popover='Name of the host. Should be unique.', editable=editable)}}
				</div>
				{{!helper.get_string_input(elt, 'host_name', 'Hostname', span='span6', popover='Name of the host. Should be unique.', editable=editable)}}
