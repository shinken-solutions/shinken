...
class TestNotif(ShinkenTest):
    ...
    def test_continuous_notifications_delayed(self):
        ...
        self.show_logs()
        self.assertTrue(self.assert_log_match(1, 'SERVICE NOTIFICATION.*;CRITICAL;'))
        self.show_and_clear_logs()
        self.show_actions()
        #-----------------------------------------------------------------
        ...
        self.assertTrue(self.assert_log_match(1, 'SERVICE ALERT.*;OK;'))
        self.assertTrue(self.assert_log_match(2, 'SERVICE EVENT HANDLER.*;OK;'))
        self.assertTrue(self.assert_log_match(3, 'SERVICE NOTIFICATION.*;OK;'))
        # evt reap 2 loops
        self.assertEqual(0, svc.current_notification_number)
    ...
    def test_continuous_notifications_delayed_recovers_fast(self):
        ...
        #-----------------------------------------------------------------
        self.scheduler_loop(1, [[svc, 0, 'GOOD']], do_sleep=True, sleep_time=0.1)
        self.assert_(self.assert_log_match(1, 'SERVICE ALERT.*;OK;'))
        self.assert_(self.assert_log_match(2, 'SERVICE EVENT HANDLER.*;OK;'))
    ...
    def test_host_in_downtime_or_down_service_critical(self):
        ...
        self.show_logs()
        self.show_actions()
        self.assert_(self.assert_log_match(1, 'SERVICE ALERT.*;CRITICAL;SOFT'))
        self.assert_(self.assert_log_match(2, 'SERVICE EVENT HANDLER.*;CRITICAL;SOFT'))
        self.assert_(self.assert_log_match(3, 'SERVICE ALERT.*;CRITICAL;HARD'))
        self.assert_(self.assert_log_match(4, 'SERVICE EVENT HANDLER.*;CRITICAL;HARD'))
        self.assert_(self.assert_log_match(5, 'SERVICE NOTIFICATION.*;CRITICAL;'))
        self.assertEqual(1, svc.current_notification_number)
        self.clear_logs()
        self.clear_actions()
        #--------------------------------------------------------------
