...
from shinken.modules.retention_nagios import module as nagios_retention_file_scheduler
from shinken.modules.retention_nagios.module import get_instance
