...
class TestUnknownNotChangeState(ShinkenTest):
    ...
    def test_unknown_do_not_change_state(self):
        ...
        self.any_log_match('SERVICE NOTIFICATION.*;CRITICAL')
        ...
        self.no_log_match('SERVICE NOTIFICATION.*;UNKNOWN')
        self.show_and_clear_logs()
    ...
    def test_unknown_do_not_change_state_with_different_exit_status_phase(self):
        ...
        print svc.state, svc.state_type
        self.any_log_match('SERVICE NOTIFICATION.*;WARNING')
        self.show_and_clear_logs()
    ...
    def test_unknown_still_raise_notif(self):
        ...
        # Should have a notification about it!
        self.any_log_match('SERVICE NOTIFICATION.*;UNKNOWN')
        self.show_and_clear_logs()
    ...
    def test_unreach_do_not_change_state(self):
        ...
        # Should have a notification about it
        self.any_log_match('HOST NOTIFICATION.*;DOWN')
        self.show_and_clear_logs()
        ...
        self.any_log_match('HOST NOTIFICATION.*;UP')
        self.show_and_clear_logs()
        ...
        self.no_log_match('HOST NOTIFICATION.*;DOWN')
        self.show_and_clear_logs()
