...
from shinken.modules.memcache_retention_scheduler import module as memcache_retention_scheduler
from shinken.modules.memcache_retention_scheduler.module import get_instance
