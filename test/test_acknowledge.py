...
class TestAcks(ShinkenTest):
    ...
    def test_ack_soft_service(self):
        ...
        self.assert_(self.assert_log_match(3, 'ACKNOWLEDGEMENT \(CRITICAL\)'))
        self.show_and_clear_logs()
        self.show_actions()
    ...
    def test_ack_hard_service(self):
        ...
        self.show_logs()
        self.show_actions()
        self.assert_(self.assert_log_match(1, 'SERVICE NOTIFICATION'))
        self.assert_(self.assert_log_match(2, 'SERVICE NOTIFICATION'))
        self.assertEqual(2, self.count_logs())
    ...
    def test_ack_nonsticky_changing_service(self):
        ...
        self.show_logs()
        self.show_actions()
        self.assert_(self.assert_log_match(1, 'SERVICE ALERT.*WARNING'))
        self.assert_(self.assert_log_match(2, 'SERVICE NOTIFICATION'))
        self.assert_(self.assert_log_match(3, 'SERVICE NOTIFICATION'))
    ...
    def test_ack_soft_host(self):
        ...
        self.assertEqual(3, self.count_actions())
        self.assert_(self.assert_log_match(7, 'HOST NOTIFICATION'))
        self.show_and_clear_logs()
        self.show_and_clear_actions()
        # clean up
        self.scheduler_loop(1, [[host, 0, 'UP']])
        ...
        self.assert_(self.assert_log_match(3, 'ACKNOWLEDGEMENT \(DOWN\)'))
        self.show_and_clear_logs()
        self.show_actions()
    ...
    def test_ack_hard_host(self):
        ...
        #self.worker_loop()
        self.assert_(host.problem_has_been_acknowledged)
        self.assert_(self.assert_log_match(1, 'ACKNOWLEDGEMENT \(DOWN\)'))
        self.scheduler_loop(2, [[host, 2, 'DOWN']], do_sleep=True)
        self.assertEqual(1, self.count_logs())
        self.assertEqual(1, self.count_actions())
        self.show_and_clear_logs()
        ...
        self.show_logs()
        self.show_actions()
        self.assert_(self.assert_log_match(1, 'HOST NOTIFICATION'))
        self.assert_(self.assert_log_match(2, 'HOST NOTIFICATION'))
        self.assertEqual(2, self.count_logs())
        self.assertEqual(2, self.count_actions())  # master sched, contact zombie
    ...
    def test_unack_removes_comments(self):
        ...
        self.show_logs()
        self.assert_(self.assert_log_match(1, 'ACKNOWLEDGEMENT \(CRITICAL\)'))
        self.assert_(self.assert_log_match(2, 'ACKNOWLEDGEMENT \(CRITICAL\)'))
        self.assert_(self.assert_log_match(3, 'ACKNOWLEDGEMENT \(CRITICAL\)'))
