...
class TestConfig(unittest.TestCase):
    ...
    def test_problems_impacts(self):
        ...
        #--------------------------------------------------------------
        print "- 4 x UP -------------------------------------"
        self.scheduler_loop(1, [[host_router_0, 0, 'UP'], [host_router_1, 0, 'UP'], [host_0, 0, 'UP'], [host_1, 0, 'UP']])
        ...
        self.scheduler_loop(1, [[host_router_0, 1, 'DOWN'], [host_router_1, 2, 'DOWN']])
        ...
        self.scheduler_loop(1, [[host_router_0, 0, 'UP']])
        ...
        self.scheduler_loop(1, [[host_router_1, 0, 'UP']])
