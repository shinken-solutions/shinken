...
class LiveStatus:
    ...
    #default :
    out_map = {Host : {
            'name' : {'required' : True, 'prop' : 'host_name'},
            'alias' : {'required' : False},
            'address' : {'required' : True},
            'state' : {'required' : True, 'prop' : 'state_id'},
            ...
            'comments' : {'required' : False, 'depythonize' : 'comment_id', 'default' : ''},
            'is_flapping' : {'required' : False, 'depythonize' : from_bool_to_string, 'default' : '0'},
            'last_check' : {'required' : False, 'prop' : 'last_chk', 'depythonize' : from_float_to_int, 'default' : 0},
            'next_check' : {'required' : False, 'prop' : 'next_chk', 'depythonize' : from_float_to_int, 'default' : 0},
        ...
        Service : {
            ...
            'description' : {'required' : True, 'prop' : 'service_description'},
            'state' : {'required' : True, 'prop' : 'state_id'},
            'check_period' : {'required' : True, 'depythonize' : 'get_name'},
            'check_command' : {'required' : True, 'depythonize' : 'call'},
            ...
            'retain_status_information' : {'required' : False, 'depythonize' : from_bool_to_string, 'default' : '0'},
            'retain_nonstatus_information' : {'required' : False, 'depythonize' : from_bool_to_string, 'default' : '0'},
            'latency' : {'required' : False, 'depythonize' : to_int, 'default' : 0},
            

            'in_notification_period' : {'required' : False, 'default' : '1'},
            'comments' : {'required' : False, 'depythonize' : 'comment_id', 'default' : ''},
            'is_flapping' : {'required' : False, 'depythonize' : from_bool_to_string, 'default' : '0'},
            'host_is_flapping' : {'required' : False, 'depythonize' : from_bool_to_string, 'default' : '0'},
            'last_check' : {'required' : False, 'prop' : 'last_chk', 'depythonize' : from_float_to_int, 'default' : 0},
            'next_check' : {'required' : False, 'prop' : 'next_chk', 'depythonize' : from_float_to_int, 'default' : 0},
            'last_state_change' : {'required' : False, 'depythonize' : from_float_to_int, 'default' : 0},
        ...
        Contact : {
            'name' : {'required' : True, 'prop' : 'contact_name', 'default' : '0'},
        ...
        Hostgroup : {
            'name' : {'required' : True, 'prop' : 'hostgroup_name'},
            'alias' : {'required' : False},
            'members' : {'required' : False, 'depythonize' : 'get_name'},
        },

        Servicegroup : {
            'name' : {'required' : True, 'prop' : 'servicegroup_name'},
            'alias' : {'required' : False},
        ...
        Config : {
            ...
            'check_external_commands' : {'prop' : None, 'default' : '0'},
            ...
            'execute_host_checks' : {'prop' : None, 'default' : '0'},
            'execute_service_checks' : {'prop' : None, 'default' : '0'},
            'last_command_check' : {'prop' : None, 'default' : '0'},
            'last_log_rotation' : {'prop' : None, 'default' : '0'},
            'interval_length' : {'prop' : None, 'default' : '0'},
            ...
            'accept_active_host_checks' : {'prop' : 'active_host_checks_enabled', 'default' : '0', 'depythonize' : from_bool_to_string},
            ...
            'livestatus_version' : {'prop' : None, 'default' : '0.1'},
            'program_version' : {'prop' : None, 'default' : '0.1'}
            },
            ...
            for display in attributes:
                ...
                if display not in type_map:
                    ...
                    if prop is not None and hasattr(elt, prop) and getattr(elt, prop) != None:
                        ...
                        if len(str(value)) == 0:
                            value = ''
                    elif prop is None and 'default' in type_map[display]:
