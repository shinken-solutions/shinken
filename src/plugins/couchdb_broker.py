...
class Couchdb_broker:
    ...
    def manage_initial_servicegroup_status_brok(self, b):
        ...
        for (s_id, s_name) in b.data['members']:
            self.create_document('service_servicegroup', {'service' : s_id, 'servicegroup' : b.data['id']}, None)
    ...
    def manage_initial_contactgroup_status_brok(self, b):
        ...
        for (c_id, c_name) in b.data['members']:
            self.create_document('contact_contactgroup', {'contact' : c_id, 'contactgroup' : b.data['id']}, None)


    #A notification have just be created, we INSERT it
    def manage_notification_raise_brok(self, b):
        self.create_insert_query('notifications', b.data, b.data['id'])
