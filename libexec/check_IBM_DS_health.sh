...
print_help() {
        ...
        echo ""
        echo "IBM DS35xx/DS4x00/5x00 Health Check"
        echo "the script requires IP of at least one DS35xx/DS4x00/5x00 Controller, second is optional"
        echo ""
